...
def element_length(lst: Iterable[Sequence]) -> List[Tuple[Sequence, int]]:
    ...
    Parameters: lst (List[str]): The list of strings to process.

    Returns: List[Tuple[str, int]]: A list of tuples
        Each tuple contains a string and the length of that string.
    """
